          ...
          <div class="panel-body">
              ...
              <table id="mytable"class= "table table-striped table-bordered table-condensed table-hover" >
                ...
                <tbody>
                  ...
                  <tr v-for="row in rows"> 
                    <td  v-for="(value, key) in row" @click="itemSelected(row)">
            ...
            <div > 
              ...
              <div class="row">
                ...
                <div v-if="NoMorePages" style="color:gray" align="right"> <strong> <em>No more Pages</strong></em> </div>  
                <div class="col-sm-6">
...
<script>
 ...
 import MyLang from '../../components/languages/Languages.vue';
  ...
  module.exports = {
    ...
    props: ['tableTitle', 'selectFields', 'columnsNames', 'url', 'iconInfo', 'iconActions'],
    ...
    methods: {
      ...
      fillSelectFields:function(){
        for (var i = 0; i < this.selects.length; i++) {
            ...
            Vue.set(this, this.selects[i].name,'1');
        }
      },
