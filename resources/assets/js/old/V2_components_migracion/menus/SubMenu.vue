...
<template>
	<div>
      ...
      <div class="list-group " class="cursor-hand" v-for="subOption in subOptions">
         <router-link to="subOption.method" class="list-group-item left-panel-border" style="color:blue" >{{subOption.title}}</router-link>
      </div>
	</div>
</template>
...
<script>
  module.exports = {
  	...
  	data: function(){
        ...
        subOptions:[],
          ...
          "security": {
            ...
            "6":{"title": "Customers", "method": "/customers"},
    ...
    mounted: function(){
      var strSubMenus=JSON.stringify(this.subMenus);
