...
@section('title')
	<title> {!!Lang::get('labels.add_company')!!}</title>
@stop
...
@section('body')
	...
	@include('php.top_user_message', array('keyMessage' => 'topbar_message_create', 'transaction' => 'companies'))
	...
	<div id="transaction-panel" class="col-sm-10 align="left"">
	    ...
	    <div class="panel panel-default">
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
	     		 <h3 class="panel-title">{!!Lang::get('labels.add_company')!!}</h3>
			</div>           
	        ...
	        <div class="panel-body">
				...
				{!! Form::open(array('route' => 'companies.companies.store')) !!}

					<div class="row">
						<div class="col-sm-3 text-left">
							<div class="control-group">
								{!!Form::label(Lang::get('fields.company_name'))!!}				
								{!!Form::text('company_name','', array('class' => 'form-control','size' => '10px'))!!}
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12 text-left">
							<div class="control-group">
								...
								{!!Form::textarea('company_description','',array('class' => 'form-control','size' => '10px'))!!}
							</div>
					</div>
