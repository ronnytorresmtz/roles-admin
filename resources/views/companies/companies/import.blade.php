...
@section('title')
	<title> {!!Lang::get('labels.import_company')!!} </title>
@stop


@section('body')

	@include('php.top_user_message', array('keyMessage' => 'topbar_message_import', 'transaction' => 'companies'))
	...
	<div id="transaction-panel" class="col-lg-10" align="left">
        ...
        <div class="panel panel-default">
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
              ...
              <h3 class="panel-title">{!!Lang::get('labels.import_company')!!}</h3>
         	 ...
         	 <div class="panel-body">
				...
				{!! Form::open(array('route'=>'companies.companies.import','files'=>true)) !!}
