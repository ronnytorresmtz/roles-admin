...
@section('title')
	<title> {!!Lang::get('labels.edit_company')!!}</title>
@stop
...
@include('php.top_user_message', array('keyMessage' => 'topbar_message_edit', 'transaction' => 'companies'))
...
<div id="transaction-panel" class="col-lg-10" align="left">
    ...
    <div class="panel panel-default">
        ...
        <div id="transaction-panel-header" class="panel-heading">
          ...
          <h3 class="panel-title">{!!Lang::get('labels.edit_company')!!}</h3>
     	 ...
     	 <div class="panel-body">
			...
			{!! Form::model($company, array('route' => array('companies.companies.update',$company->id), 'method' => 'PUT')) !!}
				...
				<div class="row">
					<div class="col-sm-3 text-left">
						<div class="control-group">
							...
							{!!Form::text('company_name',null, array('class' => 'form-control','size' => '10px'))!!}
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12 text-left">
						<div class="control-group">
							...
							{!!Form::textarea('company_description',null,array('class' => 'form-control','size' => '10px'))!!}
						</div>
					</div>
				</div>
