...
@section('title')
	...
	<title> {!!Lang::get('labels.list_company')!!} </title>
@stop


@section('body')

	@include('php.top_user_message', array('keyMessage' => 'topbar_message_list', 'transaction' => 'companies'))
	...
	<div id="transaction-panel" class="col-sm-10" align="left">
	    ...
	    <div class="panel panel-default" >
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
	          <h3 class="panel-title">{!!Lang::get('labels.list_company')!!}</h3>
			</div>           
	        ...
	        <div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-4 text-right">	
						...
						{!! Form::open(array('route' => 'companies.companies.search', 'method' => 'get')) !!}
					...
					<div class="col-sm-6 text-right">
						...
						{!! Form::open(array('route'=> 'companies.companies.deleteButton'))!!}			
						
							@include('php.action_buttons',array('subMenuOption' => 'companies.companies'))
					...
					<table class= "table table-striped table-bordered table-condensed table-hover"> 
					    <thead>
					         <tr>
					            ...
					            <th data-field="name">
					            	{!!Lang::get('fields.company_name')!!}
					            </th>
					            <th  data-field="description">
					            	{!!Lang::get('fields.company_description')!!}
					            </th>
					    	...
					    	@foreach($companies as $company)
							    <tr>
							    	<td style="min-width:30px" align="center">
							    		{!! Form::checkbox('checked_items[]',$company->id) !!}
							    	</td>	
							    	<td style="min-width:0px">{!! $company->id !!}</td>
							        <td style="min-width:0px"> {!! $company->company_name !!}</td>
							        <td style="min-width:0px">{!! $company->company_description !!}</td>
							        <td style="min-width:0px">{!! $company->created_at !!}</td>
							        <td style="min-width:0px">{!! $company->updated_at !!}</td>
							    </tr>
					    	@endforeach
				...
				<div class="col-sm-3 text-left">
					<div align="left">
						...
						<p> {!!Lang::get('labels.showing')!!} {!!$companies->firstitem()!!} {!!Lang::get('labels.to')!!} {!!$companies->lastitem()!!} {!!Lang::get('labels.of')!!} {!!$companies->total()!!} {!!Lang::get('labels.items')!!} </p>
					</div>
				</div>
				<!--Display the pagination links/buttons-->
				<div class="col-sm-9 text-right">
						{!!$companies->appends(array('search_value' => $search_value))->render()!!}
				</div>
