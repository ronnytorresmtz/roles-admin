...
@section('title')
	...
	<title> {!!Lang::get('labels.list_role')!!} </title>
@stop


@section('body')

	@include('php.top_user_message', array('keyMessage' => 'topbar_message_list', 'transaction' => 'roles'))
	...
	<div id="transaction-panel" class="col-sm-10" align="left">
	    ...
	    <div class="panel panel-default" >
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
	          <h3 class="panel-title">{!!Lang::get('labels.list_role')!!}</h3>
			</div>           
	        ...
	        <div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-4 text-right">	
						...
						{!! Form::open(array('route' => 'security.roles.search', 'method' => 'get')) !!}
					...
					<div class="col-sm-6 text-right">
						...
						{!! Form::open(array('route'=> 'security.roles.deleteButton'))!!}			
						
							@include('php.action_buttons',array('subMenuOption' => 'security.roles'))
					    ...
					    <thead>
 							<tr>
					            ...
					            <th  data-field="description">
					            	{!!Lang::get('fields.role_description')!!}
					            </th>
					    ...
					    @foreach($roles as $role)
						    <tr>
						    	<td style="min-width:30px" align="center">
						    		{!! Form::checkbox('checked_items[]',$role->id) !!}
						    	</td>	
						    	<td style="min-width:0px">{!! $role->id !!}</td>
						        <td style="min-width:0px">{!! $role->role_name !!}</td>
						        <td style="min-width:0px">{!! $role->role_description !!}</td>
						        <td style="min-width:0px">{!! $role->created_at !!}</td>
						        <td style="min-width:0px">{!! $role->updated_at !!}</td>
						    </tr>
				    	@endforeach
				...
				<div class="row" padding="0px">
					<div class="col-sm-3 text-left">
						<div align="left">
							...
							<p style="font-size:13px;"> 
								{!!Lang::get('labels.showing')!!} {!!$roles->firstitem()!!} {!!Lang::get('labels.to')!!} {!!$roles->lastitem()!!} {!!Lang::get('labels.of')!!} {!!$roles->total()!!} {!!Lang::get('labels.items')!!} 
							</p>
					...
					<div class="col-sm-9 text-right" >
							{!!$roles->appends(array('search_value' => $search_value))->render()!!}
					</div>
				</div>				
			</div>	
		</div>
