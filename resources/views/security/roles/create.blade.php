...
@section('title')
	<title> {!!Lang::get('labels.add_role')!!}</title>
@stop
...
@section('body')
	...
	@include('php.top_user_message', array('keyMessage' => 'topbar_message_create', 'transaction' => 'roles'))
	...
	<div id="transaction-panel" class="col-sm-10 align="left"">
	    ...
	    <div class="panel panel-default">
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
	     		 <h3 class="panel-title">{!!Lang::get('labels.add_role')!!}</h3>
			</div>           
	        ...
	        <div class="panel-body">
				...
				{!! Form::open(array('route' => 'security.roles.store')) !!}
					...
					<div class="row">
						<div class="col-sm-3 text-left">
								<div class="control-group">
									...
									{!!Form::text('role_name','', array('class' => 'form-control','size' => '10px'))!!}
								</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-6 text-left">
							<div class="control-group">
								...
								{!!Form::text('role_description','',array('class' => 'form-control','size' => '10px'))!!}
							</div>
						</div>
					</div>
