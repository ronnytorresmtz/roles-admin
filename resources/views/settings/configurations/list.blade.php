...
@section('title')
	...
	<title> {!!Lang::get('labels.list_configuration')!!} </title>
@stop


@section('body')

	@include('php.top_user_message', array('keyMessage' => 'topbar_message_list', 'transaction' => 'configurations'))
	...
	<div id="transaction-panel" class="col-sm-10" align="left">
	    ...
	    <div class="panel panel-default" >
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
	          <h3 class="panel-title">{!!Lang::get('labels.list_configuration')!!}</h3>
			</div>           
	        ...
	        <div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-4 text-right">	
						...
						{!! Form::open(array('route' => 'settings.configurations.search', 'method' => 'get')) !!}
					...
					<div class="col-sm-6 text-right">
						...
						{!! Form::open(array('route'=> 'settings.configurations.deleteButton'))!!}			
						
							@include('php.action_buttons',array('subMenuOption' => 'settings.configurations'))
					...
					<table class= "table table-striped table-bordered table-condensed table-hover"> 
					    ...
					    <thead>
					         <tr>
					            ...
					            <th data-field="name">
					            	{!!Lang::get('fields.configuration_name')!!}
					            </th>
					            <th  data-field="description">
					            	{!!Lang::get('fields.configuration_description')!!}
					            </th>
					    	...
					    	@foreach($configurations as $configuration)
							    <tr>
							    	<td style="min-width:30px" align="center">
							    		{!! Form::checkbox('checked_items[]',$configuration->id) !!}
							    	</td>	
							    	<td style="min-width:0px">{!! $configuration->id !!}</td>
							        <td style="min-width:0px"> {!! $configuration->configuration_name !!}</td>
							        <td style="min-width:0px">{!! $configuration->configuration_description !!}</td>
							        <td style="min-width:0px">{!! $configuration->created_at !!}</td>
							        <td style="min-width:0px">{!! $configuration->updated_at !!}</td>
							    </tr>
					    	@endforeach
				...
				<div class="col-sm-3 text-left">
					<div align="left">
						...
						<p> {!!Lang::get('labels.showing')!!} {!!$configurations->firstitem()!!} {!!Lang::get('labels.to')!!} {!!$configurations->lastitem()!!} {!!Lang::get('labels.of')!!} {!!$configurations->total()!!} {!!Lang::get('labels.items')!!} </p>
					</div>
				</div>

				<!--Display the pagination links/buttons-->
				<div class="col-sm-9 text-right">
						{!!$configurations->appends(array('search_value' => $search_value))->render()!!}
				</div>
