...
@section('title')
	<title> {!!Lang::get('labels.import_configuration')!!} </title>
@stop


@section('body')

	@include('php.top_user_message', array('keyMessage' => 'topbar_message_import', 'transaction' => 'configurations'))
	...
	<div id="transaction-panel" class="col-lg-10" align="left">
        ...
        <div class="panel panel-default">
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
              ...
              <h3 class="panel-title">{!!Lang::get('labels.import_configuration')!!}</h3>
         	 ...
         	 <div class="panel-body">
				...
				{!! Form::open(array('route'=>'settings.configurations.import','files'=>true)) !!}
