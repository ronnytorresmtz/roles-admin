...
@section('title')
	<title> {!!Lang::get('labels.edit_state')!!}</title>
@stop
...
@section('body')
	...
	@include('php.top_user_message', array('keyMessage' => 'topbar_message_edit', 'transaction' => 'states'))
	...
	<div id="transaction-panel" class="col-lg-10" align="left">
        ...
        <div class="panel panel-default">
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
              ...
              <h3 class="panel-title">{!!Lang::get('labels.edit_state')!!}</h3>
         	 ...
         	 <div class="panel-body">
				...
				{!! Form::model($state, array('route' => array('data.states.update',$state[0]->id), 'method' => 'PUT')) !!}

				{!!Form::hidden('country_id',$state[0]->country_id, array('class' => 'form-control','size' => '10px', 'readonly' => 'readonly'))!!}
				...
				<div class="row">
					<div class="col-sm-3 text-left">
						<div class="control-group">
							...
							$state[0]->country_name, array('class' => 'form-control','size' => '10px', 'readonly' => 'readonly'))!!}
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-2 text-left">
						<div class="control-group">
							...
							{!!Form::text('state_name',$state[0]->state_name, array('class' => 'form-control','size' => '10px'))!!}
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-3 text-left">
						<div class="control-group">
							...
							{!!Form::text('state_description',$state[0]->state_description,array('class' => 'form-control','size' => '10px'))!!}
						</div>
					</div>
				</div>
