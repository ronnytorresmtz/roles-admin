...
@section('title')
	<title> {!!Lang::get('labels.import_state')!!} </title>
@stop


@section('body')

	@include('php.top_user_message', array('keyMessage' => 'topbar_message_import', 'transaction' => 'states'))
	...
	<div id="transaction-panel" class="col-lg-10" align="left">
        ...
        <div class="panel panel-default">
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
              ...
              <h3 class="panel-title">{!!Lang::get('labels.import_state')!!}</h3>
         	 ...
         	 <div class="panel-body">
				...
				{!! Form::open(array('route'=>'data.states.import','files'=>true)) !!}<div class="row">
					
					<div class="col-sm-3 text-left">
								<div class="control-group">
									{!!Form::label(Lang::get('fields.country_short_name'))!!}		
