...
@section('title')
	<title> {!!Lang::get('labels.view_language')!!} </title>
@stop


@section('body')

@include('php.top_user_message', array('keyMessage' => 'topbar_message_show', 'transaction' => 'languages'))
...
<div id="transaction-panel" class="col-lg-10" align="left">
    ...
    <div class="panel panel-default">
        ...
        <div id="transaction-panel-header" class="panel-heading">
          ...
          <h3 class="panel-title">{!!Lang::get('labels.view_language')!!}</h3>
       
		</div>           
     	 <div class="panel-body">

			{!! Form::model($language, array('route' => array('data.languages.show', ''), 'method' => 'GET')) !!}
				...
				<div class="row">
					<div class="col-sm-2 text-left">
						<div class="control-group">
							...
							{!!Form::text('language_name',null,array('class' => 'form-control','size' => '10px','readonly' => 'readonly'))!!}
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-3 text-left">
						<div class="control-group">
							...
							{!!Form::text('language_description',null,array('class' => 'form-control','size' => '10px','readonly' => 'readonly'))!!}
						</div>
					</div>
				</div>
