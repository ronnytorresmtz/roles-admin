...
@section('title')
	<title> {!!Lang::get('labels.import_modelTemplate')!!} </title>
@stop


@section('body')

	@include('php.top_user_message', array('keyMessage' => 'topbar_message_import', 'transaction' => 'modelTemplates'))
	...
	<div id="transaction-panel" class="col-lg-10" align="left">
        ...
        <div class="panel panel-default">
	        ...
	        <div id="transaction-panel-header" class="panel-heading">
              ...
              <h3 class="panel-title">{!!Lang::get('labels.import_modelTemplate')!!}</h3>
         	 ...
         	 <div class="panel-body">
				...
				{!! Form::open(array('route'=>'menuTemplate.modelTemplates.import','files'=>true)) !!}<div class="row">
					
					<div class="col-sm-3 text-left">
								<div class="control-group">
									{!!Form::label(Lang::get('fields.selectTemplate_short_name'))!!}		
									{!!Form::text('selectTemplate_name', 
										$selectTemplate->selectTemplate_short_name,
