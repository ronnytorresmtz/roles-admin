					...
					<div class="col-sm-3 text-left">
						<div class="control-group">
							...
							{!!Form::text('selectTemplate_name', 
								$modelTemplate[0]->selectTemplate_name ,
				...
				<div class="row">
					<div class="col-sm-3 text-left">
						<div class="control-group">
							...
							{!!Form::text('modelTemplate_name',$modelTemplate[0]->modelTemplate_name,array('class' => 'form-control','size' => '10px','readonly' => 'readonly'))!!}
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12 text-left">
						<div class="control-group">
							...
							{!!Form::textarea('modelTemplate_description',$modelTemplate[0]->modelTemplate_name,array('class' => 'form-control','size' => '10px','readonly' => 'readonly'))!!}
						</div>
					</div>
				</div>
